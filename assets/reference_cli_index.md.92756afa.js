...
<span class="line"><span style="color:#babed8;">    -m, --merge              Merge target directory if it exists</span></span></code></pre></div><p>可以在本机安装后使用：</p><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-jsE1Z" id="tab-R9cCo-x" checked="checked"><label for="tab-R9cCo-x">pnpm</label><input type="radio" name="group-jsE1Z" id="tab-E1Iw1Km"><label for="tab-E1Iw1Km">npm</label></div><div class="blocks"><div class="language-bash active"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 全局安装</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#676E95;font-style:italic;"># 创建模板</span></span>
<span class="line"><span style="color:#FFCB6B;">create-fes-app</span><span style="color:#BABED8;"> </span><span style="color:#C3E88D;">fes-app</span></span></code></pre></div></div></div><p>推荐使用 <code>pnpm create</code> 和 <code>npx</code> 方式创建模板，一直使用最新的模板：</p><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-G_hG8" id="tab-j1PGzeV" checked="checked"><label for="tab-j1PGzeV">pnpm</label><input type="radio" name="group-G_hG8" id="tab-F8MKVAb"><label for="tab-F8MKVAb">npm</label></div><div class="blocks"><div class="language-bash active"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 创建模板</span></span>
