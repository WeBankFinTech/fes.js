import{_ as a,r as l,o as r,c as d,b as n,d as e,a as i,f as t}from"./app.89d27141.js";const o={},c=n("h1",{id:"fesjs-plugin-jest",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#fesjs-plugin-jest","aria-hidden":"true"},"#"),e(" @fesjs/plugin-jest")],-1),u={href:"https://www.jestjs.cn/",target:"_blank",rel:"noopener noreferrer"},v=t(`<h2 id="启用方式" tabindex="-1"><a class="header-anchor" href="#启用方式" aria-hidden="true">#</a> 启用方式</h2><p>在 <code>package.json</code> 中引入依赖：</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
